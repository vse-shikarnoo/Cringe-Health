...
class EditDesiredWeightFragment(val application: Activity, var profilevm: ProfileVM) : DialogFragment(){
    ...
    override fun onCreateView(
        ...
        binding.acceptButton.setOnClickListener {
            ...
            editor?.apply()
            profilevm.setDesWeight(binding.desiredWeightNp1.value, binding.desiredWeightNp2.value)
            dismiss()
        }
    ...
    private fun setNumberPickers(user: MainUser?) {
        ...
        profilevm.desiredWeightNp2.observe(viewLifecycleOwner){
